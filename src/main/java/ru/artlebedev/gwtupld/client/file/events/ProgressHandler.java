 ...
 **********************************************/
package ru.artlebedev.gwtupld.client.file.events;

import com.google.gwt.event.shared.EventHandler;

/**
 * Handler interface for {@link ru.artlebedev.gwtupld.client.file.events.ProgressEvent} events.
 */
public interface ProgressHandler extends EventHandler {
	/**
	 * Called when 'progress' is fired.
	 * @param event the {@link ru.artlebedev.gwtupld.client.file.events.ProgressEvent} that was fired
	 */
