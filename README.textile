...
port to be exactly the same for server and client to be able to get contents of
the iframe (JS security restriction). So you can set up a proxy (I prefer
...
All request will go to port 8082 and then dispatched to appropriate locations.